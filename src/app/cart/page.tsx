    ...
    <div>
      ...
      <div className='mt-20 flex sm:flex-col lg:flex-row lg:mx-20 lg:gap-6 sm:gap-20'>
        ...
        <div className='bg-[#FFF9E5] '>
          <div className='mt-4 flex flex-col gap-16 md:w-[340px] h-[390px] lg:text-center justify-center items-center'>
            ...
            <Button className='w-56 h-14 lg:ml-16 sm:ml-5 rounded-2xl'><Link href="/checkout">Check out</Link></Button>
          </div>
